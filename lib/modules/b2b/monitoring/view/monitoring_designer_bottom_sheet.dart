        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: SmartText(APPStrings.selectDesigner.tr, style: style.subTitleStyle),
            ),
            SizedBox(height: 16.h),
  ...
  Widget _buildAppBar(MonitoringScreenStyle style, BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          SmartText(APPStrings.assignDesigner.tr, style: style.bottomSheetTitleStyle),
          SmartImage(
                ...
                children: [
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          SmartImage(path: bloc.designerList[index].image, height: 40.w, width: 40.w),
                          SizedBox(width: 16.w),
                          SmartText(bloc.designerList[index].name, style: style.designerNameStyle),
                          const Spacer(),
                          SmartCheckbox(
