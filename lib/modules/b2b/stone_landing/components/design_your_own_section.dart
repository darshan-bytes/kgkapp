...
class DesignYourOwnStoneSection extends StatelessWidget {
  ...
  const DesignYourOwnStoneSection({
    super.key,
    required this.style,
    required this.mainBannerForegroundImagePath,
    required this.mainBannerTitle,
    required this.mainBannerDescription,
    required this.mainBannerFirstButtonTitle,
    required this.mainBannerFirstButtonCallback,
    required this.mainBannerSecondButtonTitle,
    required this.mainBannerSecondButtonCallback,
