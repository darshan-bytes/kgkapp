...
class DiamondsStrapiModel {
  ...
  final List<DiamondsStrapiModelDiamondsStrapiModelDatum> data;
  final Meta? meta;

  factory DiamondsStrapiModel.fromJson(Map<String, dynamic> json) {
    return DiamondsStrapiModel(
      data: json["data"] == null ? [] : List<DiamondsStrapiModelDiamondsStrapiModelDatum>.from(json["data"]!.map((x) => DiamondsStrapiModelDiamondsStrapiModelDatum.fromJson(x))),
...
class DiamondsStrapiModelDiamondsStrapiModelDatum {
  DiamondsStrapiModelDiamondsStrapiModelDatum({
    required this.id,
  ...
  factory DiamondsStrapiModelDiamondsStrapiModelDatum.fromJson(Map<String, dynamic> json) {
    return DiamondsStrapiModelDiamondsStrapiModelDatum(
      id: json["id"],
...
class AboutImage {
  ...
  final List<PurpleDiamondsStrapiModelDatum> data;

  factory AboutImage.fromJson(Map<String, dynamic> json) {
    return AboutImage(
      data: json["data"] == null ? [] : List<PurpleDiamondsStrapiModelDatum>.from(json["data"]!.map((x) => PurpleDiamondsStrapiModelDatum.fromJson(x))),
    );
  }
...
class PurpleDiamondsStrapiModelDatum {
  PurpleDiamondsStrapiModelDatum({
    required this.id,
    required this.attributes,
  });
  ...
  factory PurpleDiamondsStrapiModelDatum.fromJson(Map<String, dynamic> json) {
    return PurpleDiamondsStrapiModelDatum(
      id: json["id"],
...
class CountryImage {
  ...
  final List<FluffyDiamondsStrapiModelDatum> data;

  factory CountryImage.fromJson(Map<String, dynamic> json) {
    return CountryImage(
      data: json["data"] == null ? [] : List<FluffyDiamondsStrapiModelDatum>.from(json["data"]!.map((x) => FluffyDiamondsStrapiModelDatum.fromJson(x))),
    );
  }
...
class FluffyDiamondsStrapiModelDatum {
  FluffyDiamondsStrapiModelDatum({
    required this.id,
    required this.attributes,
  });
  ...
  factory FluffyDiamondsStrapiModelDatum.fromJson(Map<String, dynamic> json) {
    return FluffyDiamondsStrapiModelDatum(
      id: json["id"],
...
//   @override
//   String toString(){
//     return "$id, $component, $slug, $button, $userType, $businessType, $poster, $info, $title, $description, $backgroundImage, $details, $country, $image, $mobileImage, $banner, $headline, $about, $faQs, $points, ";
//   }
// }
//
// class About {
...
//   @override
//   String toString(){
//     return "$id, $title, $description, $tag, $redirecTo, $redirectionType, $mobileImage, $image, ";
//   }
// }
//
// class AboutImage {
...
//   @override
//   String toString(){
//     return "$small, $medium, $thumbnail, $large, ";
//   }
// }
//
// class Large {
...
//   @override
//   String toString(){
//     return "$id, $title, $url, $mobileImage, $image, ";
//   }
// }
//
// class Banner {
...
//   @override
//   String toString(){
//     return "$id, $title, $tag, $buttonLabel, $buttonUrl, $buttonTarget, $description, $redirectTo, $redirectionType, $mobileImage, $image, ";
//   }
// }
//
// class BusinessType {
...
//   @override
//   String toString(){
//     return "$id, $title, $headline, $tagline, $sectionTitle, ";
//   }
// }
//
// class Slug {
