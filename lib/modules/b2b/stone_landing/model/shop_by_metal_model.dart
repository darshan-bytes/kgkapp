...
class ShopByMetalDatum {
  ...
  factory ShopByMetalDatum.fromJson(Map<String, dynamic> json){
    return ShopByMetalDatum(
      ...
      componentDetails: json["component_details"] == null ? [] : List<ComponentDetailShopByMetal>.from(json["component_details"]!.map((x) => ComponentDetailShopByMetal.fromJson(x))),
      multipleFinishedViewImage: json["multiple_finished_view_image"] == null ? [] : List<MultipleFinishedViewImageShopByMetal>.from(json["multiple_finished_view_image"]!.map((x) => MultipleFinishedViewImageShopByMetal.fromJson(x))),
...
class MultipleFinishedViewImageShopByMetal {
  ...
  factory MultipleFinishedViewImageShopByMetal.fromJson(Map<String, dynamic> json){
    return MultipleFinishedViewImageShopByMetal(
      ...
      multiAngleUrl: json["MULTI_ANGLE_URL"] == null ? [] : List<MultiAngleUrlShopByMetal>.from(json["MULTI_ANGLE_URL"]!.map((x) => MultiAngleUrlShopByMetal.fromJson(x))),
    );
  }
