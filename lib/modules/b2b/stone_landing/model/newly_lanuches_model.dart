class HomeNewLanuchesDatum {
  ...
  final List<HomeNewlyLauncheComponentDetail> componentDetails;
  final List<HomeNewLaunchesMultipleFinishedViewImage> multipleFinishedViewImage;
  final double? finalPrice;
  final double? discountPrice;

  HomeNewLanuchesDatum copyWith({
    String? id,
    String? suid,
    String? exclusive,
    ...
    List<HomeNewlyLauncheComponentDetail>? componentDetails,
    List<HomeNewLaunchesMultipleFinishedViewImage>? multipleFinishedViewImage,
    double? finalPrice,
...
class HomeNewlyLauncheComponentDetail {
  HomeNewlyLauncheComponentDetail({
...
class HomeNewLaunchesMultipleFinishedViewImage {
  HomeNewLaunchesMultipleFinishedViewImage({
  ...
  final List<HomeNewLaunchesMultiAngleUrl> multiAngleUrl;

  HomeNewLaunchesMultipleFinishedViewImage copyWith({
    String? contractNo,
    ...
    String? highRes3,
    String? highRes4,
    List<HomeNewLaunchesMultiAngleUrl>? multiAngleUrl,
  }) {
