...
class SortFilterBloc extends Bloc<SortFilterEvent, SortFilterState> {
  ...
  List<FilterData> filterData = [
    FilterData(
      ...
      code: 'brand',
      secondaryFilterData: [
        SecondaryFilterData(name: 'Brand 1', code: 'brand_1'),
        SecondaryFilterData(name: 'Brand 2', code: 'brand_2'),
        SecondaryFilterData(name: 'Brand 3', code: 'brand_3'),
      ],
    ),
    FilterData(
      name: 'Color',
    ...
    FilterData(
      ...
      code: 'size',
      secondaryFilterData: [
        SecondaryFilterData(name: 'Size 1', code: 'size_1'),
        SecondaryFilterData(name: 'Size 2', code: 'size_2'),
        SecondaryFilterData(name: 'Size 3', code: 'size_3'),
      ],
    ),
  ];
