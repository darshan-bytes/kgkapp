...
class WriteReviewScreen extends StatelessWidget {
      ...
      children: [
        ...
        BlocBuilder<WriteReviewBloc, WriteReviewState>(
          ...
          builder: (context, state) {
            ...
            if (bloc.imageFileList?.isNotEmpty ?? false) {
              imageWidgets.addAll(
                List.generate(
                  bloc.imageFileList!.length,
                  (index) {
                    return _buildImageThumbnail(bloc.imageFileList![index], bloc, style, index);
                  },
                ),
              );
            }
  ...
  void _showImagePickDialog(BuildContext context, WriteReviewBloc bloc) {
