  ...
  factory DiyStyleListModel.fromJson(Map<String, dynamic> json) {
    return DiyStyleListModel(
      ...
      applicableDiamondShape:
          json["applicable_diamond_shape"] == null
              ? []
...
class ApplicableDiamondShape {
  ApplicableDiamondShape({required this.shapeName, required this.shapeCode});

  final String? shapeName;
  final String? shapeCode;

  ApplicableDiamondShape copyWith({String? shapeName, String? shapeCode}) {
    return ApplicableDiamondShape(shapeName: shapeName ?? this.shapeName, shapeCode: shapeCode ?? this.shapeCode);
  }

  factory ApplicableDiamondShape.fromJson(Map<String, dynamic> json) {
    return ApplicableDiamondShape(shapeName: json["ShapeName"], shapeCode: json["ShapeCode"]);
  }

  Map<String, dynamic> toJson() => {"ShapeName": shapeName, "ShapeCode": shapeCode};
}

class MetalColor {
  MetalColor({required this.name});

  final dynamic name;

  MetalColor copyWith({dynamic name}) {
    return MetalColor(name: name ?? this.name);
  }

  factory MetalColor.fromJson(Map<String, dynamic> json) {
    return MetalColor(name: json["Name"]);
  }
