...
import 'package:kgk/widgets/design_grid_item.dart';
    ...
    return BlocBuilder<DesignListingBloc, DesignListingState>(
      ...
      builder: (context, state) {
        ...
        return Column(
          children: [
            Expanded(
              child: designListingBloc.isGrid
                  ? SmartGridView(items: designListingBloc.designList.map((item) => DesignListingGridItem(designModel: item)).toList())
                  : ListView.builder(
                      shrinkWrap: true,
