...
class DiamondListingModel {
  DiamondListingModel({required this.data, required this.filteredRecords, required this.pagination, required this.totalRecords});
...
class DiamondImage {
  DiamondImage({required this.url});

  String? url;

  factory DiamondImage.fromJson(Map<String, dynamic> json) {
    return DiamondImage(url: json["URL"]);
  }
...
class DiamondPagination {
  DiamondPagination({required this.limit, required this.page});

  String? limit;
  String? page;

  factory DiamondPagination.fromJson(Map<String, dynamic> json) {
    return DiamondPagination(limit: json["limit"].toString(), page: json["page"].toString());
  }
