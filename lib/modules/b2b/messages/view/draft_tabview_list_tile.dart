...
class DraftTabviewListTile extends StatelessWidget {
  final MessagesBloc messagesBloc;

  const DraftTabviewListTile({super.key, required this.messagesBloc});
      ...
      body: Padding(
        ...
        child: Column(
          children: [
              ...
              children: [
                Expanded(
                  child: SmartTextField.search(
                    ...
                    controller: messagesBloc.draftSearchController,
            ...
            SizedBox(height: 24.h),
            messagesBloc.buildListView(context, MessagesTab.draft),
          ],
        ),
      ),
    );
