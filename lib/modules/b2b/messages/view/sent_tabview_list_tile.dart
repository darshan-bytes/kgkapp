...
class SentTabviewListTile extends StatelessWidget {
  final MessagesBloc messagesBloc;

  const SentTabviewListTile({super.key, required this.messagesBloc});
      ...
      body: Padding(
        ...
        child: Column(
          children: [
              ...
              children: [
                Expanded(
                  child: SmartTextField.search(
                    ...
                    controller: messagesBloc.sentSearchController,
            ...
            SizedBox(height: 24.h),
            messagesBloc.buildListView(context, MessagesTab.sent),
          ],
        ),
      ),
    );
