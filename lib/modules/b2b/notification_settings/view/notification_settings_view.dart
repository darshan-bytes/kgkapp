...
class NotificationSettingsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: SmartAppBar(title: APPStrings.notificationSettings.tr),
          ...
          children: [
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SmartText(title, style: style.titleStyle, maxLines: 1, overflow: TextOverflow.ellipsis),
                  SizedBox(height: 4.h),
                  SmartText(desc, style: style.descStyle, maxLines: 2, overflow: TextOverflow.ellipsis),
                  SizedBox(height: 16.h),
                ],
              ),
            ),
            SmartSwitch(value: isEnable, onSwitchChange: onSwitchChange, thumbColor: style.thumbColor, width: 40.w),
          ],
        ),
        Divider(height: 1.h, color: style.dividerColor),
        SizedBox(height: 16.h),
      ],
    );
  }
