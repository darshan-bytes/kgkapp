...
class TrackManufacturerOrderBottomSheet extends StatelessWidget {
  const TrackManufacturerOrderBottomSheet({super.key});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 24.h),
                  _buildTrackOrderView(bloc, smartTileLineStepperStyle),
                  SizedBox(height: 16.h),
                ],
              ),
            ),
  ...
  Widget _buildTrackOrderView(ManufacturerOrderDetailsBloc bloc, SmartTileLineStepperStyle smartTileLineStepperStyle) {
