...
class RetailerJewelleryTabView extends StatelessWidget {
  ...
  const RetailerJewelleryTabView({super.key, required this.retailerOrderListingBloc});
                  ...
                  children: [
                    Expanded(
                      child: SmartTextField.search(
                        ...
                        controller: retailerOrderListingBloc.jewellerySearchController,
                        borderRadius: BorderRadius.only(topLeft: Radius.circular(4.r), bottomLeft: Radius.circular(4.r)),
          ...
          Expanded(
            child: BlocBuilder<RetailerOrderListingBloc, RetailerOrderListingState>(
              ...
              builder: (context, state) {
                if (retailerOrderListingBloc.jewelleryList.isEmpty) {
