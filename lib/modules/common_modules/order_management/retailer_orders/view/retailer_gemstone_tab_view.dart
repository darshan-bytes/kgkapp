...
class RetailerGemstoneTabView extends StatelessWidget {
  ...
  const RetailerGemstoneTabView({super.key, required this.bloc});
                ...
                children: [
                  Expanded(
                    child: SmartTextField.search(
                      ...
                      controller: bloc.gemstoneSearchController,
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return B2BListingItem(
                    ...
                    listingItemModel: bloc.retailerGemstoneOrdersList[index],
