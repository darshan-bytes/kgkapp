...
class SmartText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle finalStyle = (style ?? TextStyle(fontSize: adjustedFontSize, fontWeight: FontWeight.w400, color: Colors.black))
        .copyWith(
    ...
    Widget child =
        isAutoSizeText
            ? AutoSizeText(displayText, style: finalStyle, overflow: overflow, textAlign: textAlign, maxLines: maxLines)
            : Text(displayText, style: finalStyle, overflow: overflow, textAlign: textAlign, maxLines: maxLines);
