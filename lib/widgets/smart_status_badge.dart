...
class SmartStatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final statusText = _getStatusText(currentStatus).tr.capitalizeFirst;
    ...
    return FittedBox(
      child: Container(
        ...
        decoration: BoxDecoration(color: backgroundColor, borderRadius: BorderRadius.circular(borderRadius ?? 100.r)),
        child: Center(
          child: SmartText(
            statusText.tr,
