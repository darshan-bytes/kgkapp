...
class CommonResponse<T> {
  ...
  dynamic getModelValue(dynamic json) {
    switch (T) {
      ...
      case const (PaginationData<SkuLibraryListItemDataModel>):
        return PaginationData<SkuLibraryListItemDataModel>.fromJson(json);
      ...
      case const (ExhibitionProductDetailsDataModel):
        return ExhibitionProductDetailsDataModel.fromJson(json);
      case const (DiyDiamondDataModel):
        return DiyDiamondDataModel.fromJson(json);
      case const (PaginationData<DiyStyleListModel>):
      ...
      case const (PaginationData<PddDataModel>):
        return PaginationData<PddDataModel>.fromJson(json);
      case const (PaginationData<DiamondDataModel>):
      ...
      case const (PaginationData<UserMasterListingModelClass>):
      ...
      case const (Presentation):
        return Presentation.fromJson(json);
      case const (DiyJewelleryType):
