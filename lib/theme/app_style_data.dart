...
class LightModeTheme extends AppTheme {
  ...
  AllNotificationViewStyle get allNotificationViewStyle =>
      AllNotificationViewStyle(
        ...
        timeLabelStyle: interRegularTextStyle.copyWith(
            color: colors.color8C8C8C),
  ...
  @override
  ShippingAddressStyle get shippingAddressStyle => ShippingAddressStyle(
      titleStyle: interMediumBoldTextStyle.copyWith(fontSize: 20.sp),
      subTitleStyle: interRegularTextStyle.copyWith(
          fontSize: 16.sp, color: colors.color8C8C8C),
      whiteColor: colors.color9DCAE0,
      dividerColor: colors.colorD3DAE0,
      cancelTextStyle:
          interRegularTextStyle.copyWith(fontSize: 16.sp, color: colors.black),
      saveTextStyle:
          interRegularTextStyle.copyWith(fontSize: 16.sp, color: colors.white),

      defaultTextStyle:
          interRegularTextStyle.copyWith(fontSize: 12.sp, color: colors.color383230),
      defaultBgColor:
      colors.colorC5DEEB);
